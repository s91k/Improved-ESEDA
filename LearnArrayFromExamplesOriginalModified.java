...
//Modified TGI classifier
public class LearnArrayFromExamplesOriginalModified 
{
	...
	final static int LINES_IN_TEST_FILE = 28; //number of samples in berlinForJava.txt

	public LearnArrayFromExamplesOriginalModified(ArrayList<Integer> vector, int label) 
	{

		int LINES_IN_TEST_FILE = LearnArrayFromExamplesOriginalModified.LINES_IN_TEST_FILE;
	...
	public static void main(String[] args) throws IOException 
	{
		...
		LearnArrayFromExamplesOriginalModified examplesFEAR = new LearnArrayFromExamplesOriginalModified(vectorFEAR, 1);
		examplesFEAR.label = 1;
		//examplesFEAR.numberOfLines = 25;
		examplesFEAR.numberOfLines = 4;
		System.out.println("HERE-0  " + examplesFEAR.label);   // OK
		examplesFEAR.run();

		//call DISGUST; DISactivate the following 4 lines if necessary
		LearnArrayFromExamplesOriginalModified examplesDISGUST = new LearnArrayFromExamplesOriginalModified(vectorDISGUST, 2);
		examplesDISGUST.label = 2;
		//examplesDISGUST.numberOfLines = 14;
		examplesDISGUST.numberOfLines = 4;
		System.out.println("HERE-0  " + examplesDISGUST.label);   // OK
		examplesDISGUST.run();

		// call BOREDOM activate the following 4 lines if necessary
		LearnArrayFromExamplesOriginalModified examplesBOREDOM = new LearnArrayFromExamplesOriginalModified(vectorBOREDOM, 4);
		examplesBOREDOM.label = 4;
		//examplesBOREDOM.numberOfLines = 30;
		examplesBOREDOM.numberOfLines = 4;
		System.out.println("HERE-0  " + examplesBOREDOM.label);   // OK
		examplesBOREDOM.run();

		// call HAPPINESS activate the following 4 lines if necessary
		LearnArrayFromExamplesOriginalModified examplesHAPPINESS = new LearnArrayFromExamplesOriginalModified(vectorHAPPINESS, 3);
		examplesHAPPINESS.label = 3;
		//examplesHAPPINESS.numberOfLines = 18;
		examplesHAPPINESS.numberOfLines = 4;
		...
		LearnArrayFromExamplesOriginalModified examplesNEUTRAL = new LearnArrayFromExamplesOriginalModified(vectorNEUTRAL, 5);
		examplesNEUTRAL.label = 5;
		//examplesNEUTRAL.numberOfLines = 18;
		examplesNEUTRAL.numberOfLines = 4;
		System.out.println("HERE-0  " + examplesNEUTRAL.label);   // OK
		examplesNEUTRAL.run();


		// call SADNESS activate the following 4 lines if necessary
		LearnArrayFromExamplesOriginalModified examplesSADNESS = new LearnArrayFromExamplesOriginalModified(vectorSADNESS, 6);
		examplesSADNESS.label = 6;
		//examplesSADNESS.numberOfLines = 18;
		examplesSADNESS.numberOfLines = 4;
		System.out.println("HERE-0  " + examplesSADNESS.label);   // OK
		examplesSADNESS.run();

		LearnArrayFromExamplesOriginalModified examplesANGER = new LearnArrayFromExamplesOriginalModified(vectorANGER, 7);
		examplesANGER.label = 7;
		//examplesANGER.numberOfLines = 33;
		examplesANGER.numberOfLines = 4;
		...
		for (int i = 0; i < LINES_IN_TEST_FILE; i++) {
			...
			CtableTRAIN[i][7] = valueOfFeaturesTEST[i][10];
	...
	static public void  printTheCtable() 
	{
		for (int i = 0; i < LINES_IN_TEST_FILE; i++) 
		{
			...
			//System.out.print(examplesFEAR.editDistances[i] + ", ");
			System.out.print(i + ":\t");
			System.out.printf("%.4f,\t", CtableTRAIN[i][0]);
			System.out.printf("%.4f,\t", CtableTRAIN[i][1]);
			System.out.printf("%.4f,\t", CtableTRAIN[i][2]);
			System.out.printf("%.4f,\t", CtableTRAIN[i][3]);			
			System.out.printf("%.4f,\t", CtableTRAIN[i][4]);
			System.out.printf("%.4f,\t", CtableTRAIN[i][5]);			
			System.out.printf("%.4f,\t", CtableTRAIN[i][6]);
			System.out.printf("%.4f,\t", CtableTRAIN[i][7]);
		...
		try 
		{
			...
			while ((l1 = inputStream.readLine()) != null) 
			{
				...
				for (int i = 0; i < fs.length; i++) 
				{
					...
					if (i == 10) 
					{
						CtableTRAIN[sampleId][7] = valueOfFeaturesTEST[i][10];
					}
				}
	...
	{
		int countSpaces = 0;
		int positionSpace1 = -1;
		int positionSpace2 = -1;
		...
		for (int i = 0; i < firstLine.length(); i++) 
		{
			...
			if (positionSpace1 == -1 && countSpaces == arg) 
			{
				// if (countSpaces == arg - 1) {
				positionSpace1 = i;
			}
			
			if (positionSpace2 == -1 && countSpaces == arg + 1) 
			{
				// if (countSpaces == arg) {
				positionSpace2 = i;
			}
		...
		for (int i = positionSpace1; i < positionSpace2; i++) 
		{
